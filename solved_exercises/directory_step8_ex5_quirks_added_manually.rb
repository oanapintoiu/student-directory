...
def print(students)
  ...
  until student_count == students.length
    ...
    puts "#{student_count + 1}. #{students[student_count][:name]}
  is part of the #{students[student_count][:cohort]}
   cohort and has the following quirk: #{students[student_count][:quirk]}.".center(5)
    student_count += 1
  end
end
# end
